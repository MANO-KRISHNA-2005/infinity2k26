...
$this_event = "ProZone"; $slug = "prozone";

// 1. Database Check for Global Accessibility
...
if (!$portal_status || $portal_status['is_active'] == 0) {
    die("<div style='background:#0a0510; color:#ff4d4d; padding:100px; text-align:center; height:100vh; font-family:Orbitron; box-sizing:border-box;'>
        ...
        <p style='font-size:0.7rem; margin-top:40px; opacity:0.3;'>Access can be enabled from the main event management dashboard.</p>
    </div>");
}

// 2. Portal Password flow
